...
class OSVOS(nn.Module):
    def __init__(self, pretrained=1, models_dir="/content/OSVOS-Pytorch/models"):
    ...
    def _initialize_weights(self, pretrained):
        ...
        if pretrained == 1:
            ...
            _vgg.load_state_dict(torch.load(os.path.join(models_dir, 'vgg_pytorch.pth'),
            ...
            caffe_weights = scipy.io.loadmat(os.path.join(models_dir(), 'vgg_caffe.mat'))
            # Core network
            caffe_ind = 0
